# v1be studio — Full Site Build Spec (Codex)

**KİME:** Codex — boş bir klasörde başlat, bu dosyayı repo köküne `AGENTS.md` olarak koy ve "Build the site described in AGENTS.md" de.
**NE YAPILACAK:** Site sıfırdan inşa edilecek. Tasarım, içerik, animasyon ve SEO/GEO kararlarının tamamı bu dosyada — Codex'un bu dosya dışında karar icat etmesi gerekmiyor; boşluk bulursa sormalı, varsaymamalı.
