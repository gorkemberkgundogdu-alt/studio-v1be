 ...
 * gerçek v1be paleti (koyu mor + krem + lime) ile üretir. Build öncesi çalışır
...
const BASE = "#1d123c"; // --color-base
const CREAM = "#fff8e8"; // --color-ink / --color-cream
const ACCENT = "#d1f300"; // --color-accent (lime)
const MUTED = "#a89bc4"; // krem'in mora doğru soluk hali (alt metin)
const MUTED_2 = "#6f5e94"; // daha da soluk
...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <text x="98" y="430" font-family="Montserrat, Arial, sans-serif" font-size="34" font-weight="500" fill="${MUTED}">
    Websites engineered to be cited — not just indexed.
  </text>
  <text x="98" y="480" font-family="Montserrat, Arial, sans-serif" font-size="26" font-weight="500" fill="${MUTED_2}">
